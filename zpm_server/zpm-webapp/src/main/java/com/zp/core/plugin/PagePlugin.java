...
import com.zp.core.util.ReflectHelper;
			...
			if(mappedStatement.getId().matches(pageSqlId)){ //拦截需要分页的SQL
				...
				if(parameterObject==null){
					...
					if(parameterObject instanceof Page){	//参数就是Page实体
						...
						boolean flag = false;
						if (null == pageField  &&  parameterObject instanceof HashMap) {//TangHaibo Edit 解决map参数 设置page对象的问题
