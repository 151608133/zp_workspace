...
<html>
	...
	<form action="analysis/analyze" method="post" id="myform">
		...
		<div class="right" style="margin-bottom: 50px;">
			<iframe src="${iframeAnalyzeSrc}" id="iframeAnalyze" frameborder="0" scrolling="no" style="width: 700px;heighy:500px;height: 500px;margin-top: 80px;margin-right: 20px;">
			</iframe>
		</div>
<div id="container" style="min-width: 310px; max-width: 600px; height: 400px; margin: 0 0"></div>
</form>
...
var hotDocument=eval('${hotDocument}');
