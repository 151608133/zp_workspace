...
<body>
	<form  action="addUser"  id="menuForm"  method="post" >	
	<div class="sy-right">
  	<div class="xdd-bjgl">
    <div class="yh">
	    <div class="yh-bt mt30"><span>添加用户信息</span></div>
	    <input type="hidden" name="flag" id="flag" value="${flag}" />
	    <div class="tc-nr-wz-hmd"><span class="yh-js"><span class="red">*</span>账号：</span><input type="text" name="userName" id="userName" value="${user.userName}" class="input-bjh" onblur="checkUserName()"></div>
	    <div class="tc-nr-wz-hmd"><span class="yh-js"><span class="red">*</span>密码：</span><input type="password" name="password" id="password" value="${user.password}" class="input-bjh" ></div>     
	    ...
	    <div class="tc-nr-wz-hmd"><span class="yh-js"><span class="red">*</span>手机号码：</span><input type="text"/ name="contactPhone" id="contactPhone" value="${user.contactPhone}" class="input-bjh"></div>
	    <div class="tc-nr-wz-hmd"><span class="yh-js"><span class="red">*</span>姓名：</span><input type="text"/ name="realName" id="realName" value="${user.realName}" class="input-bjh"></div>
	    <div class="tc-nr-wz-hmd"><span class="yh-js">邮箱：</span><input type="text"/ name="email" id="email" value="${user.realName}" class="input-bjh"></div>
		<div class="tc-nr-wz-hmd" id="dj"><span class="yh-js"><span class="red">*</span>角色：</span>
  	  ...
  	  <div class="tc-nr-wz-hmd"  id="dj"><span class="yh-js"><span class="red">*</span>区域：</span>
